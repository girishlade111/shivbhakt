...
import shivneriFortImg from "@/public/images/shivneri-fort.jpg";
import youngShivajiImg from "@/public/images/young-shivaji-jijabai.jpg";
...
function EntryImageBlock({ entry }: { readonly entry: EarlyLifeEntry }) {
  return (
    ...
    >
      <RoyalFrame className="transition-shadow duration-300 group-hover:border-brightgold/70 group-hover:shadow-[0_0_35px_rgba(255,215,0,0.25)]">
        <Image
          src={entry.image}
          alt={entry.alt}
          placeholder="blur"
